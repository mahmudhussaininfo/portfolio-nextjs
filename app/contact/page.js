  ...
  return (
    <>
      <div className="md:container md:mx-auto">
        ...
        <div className="md:w-[80%] lg:w-[70%] md:mx-auto flex flex-col md:flex-row items-center gap-20 justify-between px-0 md:px-4 py-20">
        ...
        <div className="relative group">
          <iframe
            ...
            width="600"
            height="450"
            className="md:w-[70%] w-full px-5 md-px-0 mx-auto shadow-md my-16 rounded-lg block md:group-hover:scale-110 md:transition-transform md:duration-500"
